    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createDataModalLabel">Ver Detalles De La Categoria</h5>
            ...
            <div class="modal-body">
                ...
                <div class="card mb-3" style="max-width: 540px;">
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="https://www.shutterstock.com/image-vector/vector-illustration-online-education-concepts-600w-1795834858.jpg"
                                class="img-fluid rounded-start" alt="...">
                        </div>
                        <div class="col-md-8">
                            <div class="card-body">
                                <h5 class="card-title">Categoria:{{ $nombre }}</h5>
                                <p class="card-text">Tipo de Categoria:{{ $Tipo }}</p>
                                <p class="card-text">Descripcion:{{ $descripcion }}</p>
                                <p class="card-text">El estado de la categoria es: <small
                                        class="  text-white  bg-warning">{{ $Estado }}</small></p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary">
                <h5 class="modal-title text-white text-center" id="exampleModalLabel">Añadir Categoria o Genero Literario</h5>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header bg-primary text-center ">
                <h5 class="modal-title text-white" id="exampleModalLabel">Editar Categoria o Genero Literario</h5>
                <button type="button" wire:click="cancelar" class="btn-close" data-bs-dismiss="modal"
                    aria-label="Close"></button>
            </div>
            <div class="modal-body">
                ...
                <form wire:submit.prevent="actualizarCategoria">
                    ...
                    <div class="mb-4">
                        <label for="" class="form-label">Cambiar Estado de la Categoria</label>
