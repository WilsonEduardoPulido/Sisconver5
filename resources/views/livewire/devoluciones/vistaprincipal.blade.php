    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            <div class="card">
                    ...
                    <div style="display: flex; justify-content: space-between; align-items: center;">
                        ...
                        <div>
                            <input wire:model='keyWord' type="text" class="form-control" name="search" id="search"
                                   placeholder="Search Devolucions">
                        </div>
                ...
                <div class="card-body">
                    @include('livewire.devoluciones.modals')
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item"
                                                       onclick="confirm('Confirm Delete Devolucion id {{$row->id}}? \nDeleted Devoluciones cannot be recovered!')||event.stopImmediatePropagation()"
