                ...
                <form wire:submit.prevent="crearCategoria">
                    ...
                    <form>
                        ...
                        <div class="form-group">
                            ...
                            <input wire:model="CantidadPrestada" type="text" class="form-control" id="elementos_id" placeholder="Elementos Id">@error('elementos_id') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>

                        <div class="form-group">
                            <label for="elementos_id">Elemento o Libro Prestado</label>
                            <input wire:model="ArticuloPrestado" type="text" class="form-control" id="elementos_id" placeholder="Elementos Id">@error('elementos_id') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
                        <div class="form-group">
                            <label for="elementos_id">Usuario</label>
                            @foreach ($consultaUsuariosPrestamos as $usuario)
                        <option wire:model="usuarioDeudor"selected value="{{ $usuario->id }}"> {{ $usuario->name }}
                        </option>
                    @endforeach
                        </div>
                        <div class="form-group">
                            <label for="curso_id"></label>
                            <input wire:model="usuarioDeudor" type="text" class="form-control" id="curso_id" placeholder="Curso Id">@error('curso_id') <span class="error text-danger">{{ $message }}</span> @enderror
                        </div>
